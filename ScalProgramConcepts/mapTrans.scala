...
//  )
//
//  val structuresparkschema = new StructType()
...
//    spark.sparkContext.parallelize(structureData),structuresparkschema)
//  df2.printsparkschema()
//  df2.show(false)
//
